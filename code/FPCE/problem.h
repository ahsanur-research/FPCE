...
typedef struct {
  ...
  BARRAY BA2;
#endif
SGRAPH *subg;//AuthorA:to use in getSubgraph function and
            //to generate children of current quasi-clique till PP->frq_lb = 1
//GHashTable* nbrsHash;//AuthorA: added to maintain neighborhood of K
//GHashTable* itemsetHash;//AuthorA: added to keep track of degK values of vertices in the neighborhood of K
//roaring_bitmap_t* nbrsHash;//AuthorA: added to maintain neighborhood of K
roaring_bitmap_t* itemsetHash;//AuthorA: added to keep track of degK values of vertices in the neighborhood of K
